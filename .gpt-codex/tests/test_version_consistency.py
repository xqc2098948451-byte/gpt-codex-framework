...
class VersionConsistencyTests(unittest.TestCase):
    ...
    def test_current_framework_release_metadata_is_v221(self):
        ...
        self.assertEqual(version, "2.2.2-local.1")
    ...
    def test_current_docs_and_changelog_name_v221(self):
        ...
        self.assertIn("## v2.2.2-local.1", changelog)
        self.assertIn("Framework v2.2.2-local.1", readme)
        self.assertIn("Framework v2.2.2-local.1", bootstrap)
        self.assertIn("Framework v2.2.2-local.1", agents)
