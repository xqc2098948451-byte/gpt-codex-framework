...
class VersionConsistencyTests(unittest.TestCase):
    def test_current_release_artifact_metadata_points_to_projection_sha(self):
    ...
    def test_current_framework_release_metadata_is_v260(self):
    ...
    def test_current_docs_and_changelog_name_v260(self):
        ...
        self.assertIn("Framework v2.6.0", readme)
        self.assertIn("Framework v2.6.0", bootstrap)
        self.assertIn("Framework v2.6.0", agents)
